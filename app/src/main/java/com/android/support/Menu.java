...
public class Menu {
    ...
    int CategoryBG = Color.parseColor("#FF0A02");
    ...
    public Menu(Context context) {
        ...
        mExpanded.setPadding(0, 0, 0, 0); //So borders would be visible
        ...
        gdMenuBody.setStroke(4, Color.parseColor("#000000")); //Set border
